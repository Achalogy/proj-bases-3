...
-- Inicio src/DFisico/DDL.sql
  ...
  create table producto (
     ...
     descuento number check (descuento <= 100 AND descuento >= 0),
...
-- Inicio src/entrega/1-procedimientos/PRO-1.1.sql
...
-- Fin src/entrega/1-procedimientos/PRO-1.1.sql

-- Inicio src/entrega/1-procedimientos/PRO-1.sql
...
-- Fin src/entrega/1-procedimientos/PRO-1.sql
...
-- Inicio src/entrega/6-ampliando/AMP-3.sql
  ...
  BEGIN
      ...
      END IF;
  END;
-- Fin src/entrega/6-ampliando/AMP-3.sql
